...
#define AI_FMT_QMASK \
  ((_FMT_FBITS_MASK << _FMT_FBITS_BITS) | (_FMT_BITS_MASK << _FMT_BITS_BITS) | (_FMT_PMASK_MASK << _FMT_PMASK_BITS))
...
#define AI_FMT_GET_FBITS(fmt) ((ai_i8)_FMT_GET(fmt, _FMT_FBITS_MASK, _FMT_FBITS_BITS) - _FMT_FBITS_BIAS)
...
#define AI_FMT_GET_IBITS(fmt_) ((ai_i16)AI_FMT_GET_BITS(fmt_) - AI_FMT_GET_FBITS(fmt_) - AI_FMT_GET_SIGN(fmt_))

/*! ai_buffer format handlers section *****************************************/

#define AI_BUFFER_FMT_MASK_Q(fmt_) (AI_BUFFER_FMT_OBJ(fmt_) & 0xFFFFC000)

#define AI_BUFFER_FMT_GET_Q(fmt_) (AI_BUFFER_FMT_MASK_Q(fmt_) | AI_BUFFER_FMT_SET_FBITS(0) | AI_BUFFER_FMT_SET_FBITS(0))

#define AI_BUFFER_FMT_SET_Q(bits_, fbits_) AI_BUFFER_FMT_SET(AI_BUFFER_FMT_TYPE_Q, 1, 0, bits_, fbits_)

#define AI_BUFFER_FMT_IS_Q(fmt_) \
  ((AI_BUFFER_FMT_TYPE_Q == AI_BUFFER_FMT_GET_TYPE(fmt_)) && (1 == AI_BUFFER_FMT_GET_SIGN(fmt_)))

#define AI_BUFFER_FMT_SET_UQ(bits_, fbits_) AI_BUFFER_FMT_SET(AI_BUFFER_FMT_TYPE_Q, 0, 0, bits_, fbits_)
...
#define AI_ARRAY_FMT_IS_Q(fmt_) (AI_FMT_GET(AI_FMT_MASK_Q(AI_ARRAY_FORMAT_Q)) == AI_FMT_GET(AI_FMT_MASK_Q(fmt_)))
...
#define AI_ARRAY_FMT_IS_UQ(fmt_) (AI_FMT_GET(AI_FMT_MASK_Q(AI_ARRAY_FORMAT_UQ)) == AI_FMT_GET(AI_FMT_MASK_Q(fmt_)))
 ...
 */
typedef enum {
#define FMT_ENTRY(exp_, name_, type_id_, sign_bit_, complex_bit_, pmask_, bits_, fbits_, ldiv_bits_) \
  AI_ARRAY_FMT_ENTRY(name_) =                                                                        \
      (AI_FMT_SET_COMPLEX(complex_bit_) | AI_FMT_SET_SIGN(sign_bit_) | AI_FMT_SET_BITS(bits_) |      \
       AI_FMT_SET_FBITS(fbits_) | AI_FMT_SET_PMASK(pmask_) | AI_FMT_SET_TYPE(type_id_) | AI_FMT_SET_LDIV(ldiv_bits_)),
