 ...
 **/
typedef void (*stai_event_cb)(void* cb_cookie, const stai_event_type event_type, const void* event_payload);
...
STAI_API_ENTRY
stai_format stai_init_format(const stai_format_type type, const int8_t sign, const int32_t bits, const int32_t fbits);
