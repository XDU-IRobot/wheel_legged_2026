...
#define AI_LOG_CHANNEL_PUSH(level_, fn_, udata_) AI_WRAP_FUNC(ai_log_channel_push(level_, fn_, udata_);)
...
#define AI_LOG_SUDO(fmt, ...) AI_WRAP_FUNC(ai_log_log(LOG_SUDO, __FILE__, __LINE__, fmt LOG_CR, ##__VA_ARGS__);)
#else
#define AI_LOG_SUDO(fmt, ...) AI_WRAP_FUNC(/*AI_LOG_SUDO()*/)
#endif

#if defined HAS_LOG && (HAS_LOG >= LOG_TRACE)
#define AI_LOG_TRACE(fmt, ...) AI_WRAP_FUNC(ai_log_log(LOG_TRACE, __FILE__, __LINE__, fmt LOG_CR, ##__VA_ARGS__);)
#else
#define AI_LOG_TRACE(fmt, ...) AI_WRAP_FUNC(/*AI_LOG_TRACE()*/)
#endif

#if defined HAS_LOG && (HAS_LOG >= LOG_DEBUG)
#define AI_LOG_DEBUG(fmt, ...) AI_WRAP_FUNC(ai_log_log(LOG_DEBUG, __FILE__, __LINE__, fmt LOG_CR, ##__VA_ARGS__);)
#else
#define AI_LOG_DEBUG(fmt, ...) AI_WRAP_FUNC(/*AI_LOG_DEBUG()*/)
#endif

#if defined HAS_LOG && (HAS_LOG >= LOG_INFO)
#define AI_LOG_INFO(fmt, ...) AI_WRAP_FUNC(ai_log_log(LOG_INFO, __FILE__, __LINE__, fmt LOG_CR, ##__VA_ARGS__);)
#else
#define AI_LOG_INFO(fmt, ...) AI_WRAP_FUNC(/*AI_LOG_INFO()*/)
#endif

#if defined HAS_LOG && (HAS_LOG >= LOG_WARN)
#define AI_LOG_WARN(fmt, ...) AI_WRAP_FUNC(ai_log_log(LOG_WARN, __FILE__, __LINE__, fmt LOG_CR, ##__VA_ARGS__);)
#else
#define AI_LOG_WARN(fmt, ...) AI_WRAP_FUNC(/*AI_LOG_WARN()*/)
#endif

#if defined HAS_LOG && (HAS_LOG >= LOG_ERROR)
#define AI_LOG_ERROR(fmt, ...) AI_WRAP_FUNC(ai_log_log(LOG_ERROR, __FILE__, __LINE__, fmt LOG_CR, ##__VA_ARGS__);)
#else
#define AI_LOG_ERROR(fmt, ...) AI_WRAP_FUNC(/*AI_LOG_ERROR()*/)
#endif

#if defined HAS_LOG && (HAS_LOG >= LOG_FATAL)
#define AI_LOG_FATAL(fmt, ...) AI_WRAP_FUNC(ai_log_log(LOG_FATAL, __FILE__, __LINE__, fmt LOG_CR, ##__VA_ARGS__);)
#else
