...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE (1160)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE (1160)

#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  {                                   \
      161444,                         \
  }
#define AI_NETWORK_DATA_WEIGHTS_SIZE (161444)
#define AI_NETWORK_DATA_WEIGHTS_COUNT (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE (161444)
