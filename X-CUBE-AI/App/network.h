...
#define AI_NETWORK_ORIGIN_MODEL_NAME "policy"
...
#define AI_NETWORK_IN_2_CHANNEL (135)
#define AI_NETWORK_IN_2_SIZE (135)
#define AI_NETWORK_IN_2_SIZE_BYTES (540)
