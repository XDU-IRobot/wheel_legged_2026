...
Fsm::State ResolveForceState(const Fsm::LegLengthMode leg_length_mode,
                             const bool small_gyro_enable) {
...
bool IsJumpState(const Fsm::State mode) {
  return mode == Fsm::State::kJumpRetract1 || mode == Fsm::State::kJumpExtend ||
         mode == Fsm::State::kJumpRetract2;
}
...
struct ModeRequestEvent : public etl::message<1> {
  ...
  explicit ModeRequestEvent(const bool force_enable,
                            const Fsm::LegLengthMode leg_length_mode,
                            const bool small_gyro_enable,
                            const bool jump_trigger_rise,
                            const float current_leg_length_m,
                            const uint32_t tick_ms)
      : force_enable(force_enable), leg_length_mode(leg_length_mode),
        small_gyro_enable(small_gyro_enable),
        jump_trigger_rise(jump_trigger_rise),
        current_leg_length_m(current_leg_length_m), tick_ms(tick_ms) {}
};

class FsmEtlContext;

// 无力态。
class NoForceState : public etl::fsm_state<FsmEtlContext, NoForceState,
                                           kNoForceState, ModeRequestEvent> {
public:
...
class NormalLowLegState
    : public etl::fsm_state<FsmEtlContext, NormalLowLegState,
                            kNormalLowLegState, ModeRequestEvent> {
public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
  etl::fsm_state_id_t on_enter_state();
...
class NormalMidLegState
    : public etl::fsm_state<FsmEtlContext, NormalMidLegState,
                            kNormalMidLegState, ModeRequestEvent> {
public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
  etl::fsm_state_id_t on_enter_state();
...
class NormalHighLegState
    : public etl::fsm_state<FsmEtlContext, NormalHighLegState,
                            kNormalHighLegState, ModeRequestEvent> {
public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
  etl::fsm_state_id_t on_enter_state();
...
class SmallGyroState
    : public etl::fsm_state<FsmEtlContext, SmallGyroState, kSmallGyroState,
                            ModeRequestEvent> {
public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
...
class JumpRetract1State
    : public etl::fsm_state<FsmEtlContext, JumpRetract1State,
                            kJumpRetract1State, ModeRequestEvent> {
public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
  etl::fsm_state_id_t on_enter_state();
...
class JumpExtendState
    : public etl::fsm_state<FsmEtlContext, JumpExtendState, kJumpExtendState,
                            ModeRequestEvent> {
public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
...
class JumpRetract2State
    : public etl::fsm_state<FsmEtlContext, JumpRetract2State,
                            kJumpRetract2State, ModeRequestEvent> {
public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
  etl::fsm_state_id_t on_enter_state();
...
public:
  ...
  etl::fsm_state_id_t ResolveRequestedState(const ModeRequestEvent &event) const {
    return ToEtlStateId(ResolveForceState(event.leg_length_mode,
                                          event.small_gyro_enable));
  }
...
etl::fsm_state_id_t NoForceState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t NormalLowLegState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t NormalMidLegState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t NormalHighLegState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t SmallGyroState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t JumpRetract1State::on_event(const ModeRequestEvent &event) {
  ...
  return get_fsm_context().JumpPhaseElapsedMs() >= kJumpRetract1Ms
             ? kJumpExtendState
             : No_State_Change;
}

etl::fsm_state_id_t JumpRetract1State::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t JumpExtendState::on_event(const ModeRequestEvent &event) {
  ...
  const bool leg_reached =
      event.current_leg_length_m >= (kJumpExtendTargetLegLengthM - kJumpExtendReachTolM);
...
etl::fsm_state_id_t JumpExtendState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t JumpRetract2State::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
Fsm::Output Fsm::Update(const Input &input) {
  ...
  const bool should_dispatch = jump_trigger_rise || IsJumpState(mode_) ||
                               (ToEtlStateId(ResolveForceState(input.leg_length_mode,
                                                              input.small_gyro_enable)) !=
                                ToEtlStateId(mode_)) ||
                               (mode_ == State::kNoForce && input.force_enable) ||
                               (mode_ != State::kNoForce && !input.force_enable);
  ...
  etl_impl_->context.Dispatch(ModeRequestEvent{input.force_enable,
