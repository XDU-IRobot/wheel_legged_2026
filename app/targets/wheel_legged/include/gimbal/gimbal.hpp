  ...
  void Update(const UpdateInput &input) {
    {
      ...
      output_.pitch_cmd_torque_nm = std::clamp(
          controller_.output().pitch + ff.pitch + wheel_legged::params::active::gimbal::kPitchFeedforwardBiasNm, -28.f,28.f);
          // controller_.output().pitch + wheel_legged::params::active::gimbal::kPitchFeedforwardBiasNm, -28.f,28.f);
          // controller_.output().pitch, -28.f,28.f);
