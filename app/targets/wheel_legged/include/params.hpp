...
// ==== 姿态安全/倒地恢复 ====
constexpr float kStandupPhase0ThetaTargetRad = 1.7f;   ///< 起立 Phase 0 腿摆角目标 [rad]（摆腿）
...
constexpr std::array<float, 4> kCompensationGain{0.7f, 0.7f, 0.7f, 0.7f};
constexpr std::array<float, 5> kBandwidthRadS{7.0f, 7.0f, 7.0f, 7.0f, 12.0f};
...
constexpr std::array<float, 4> kCompensationLimitNm{3.f, 3.f, 10.0f, 10.0f};
constexpr std::array<float, 4> kCompensationSlewPerTickNm{0.01f, 0.01f, 0.02f, 0.02f};
}  // namespace leso
