...
constexpr StairClimbParams kStairClimb{
    ...
    .retract_length_tolerance = 0.08f,
    .hook_stable_ms = 180U,
    ...
    .stair_theta_pid = {10.0f, 0.0f, 0.5f, 10.0f, 0.0f},
};
...
constexpr StairClimbParams kStairClimb{
    ...
    .hook_theta_tolerance_rad = 0.3f,
    .leg_length_tolerance_m = 0.05f,
    .settle_theta_tolerance_rad = 0.2f,
    .settle_theta_target_rad = -0.1f,
    .retract_length_tolerance = 0.1f,
    .hook_stable_ms = 1000U,
    .retract_stable_ms = 2000U,
    .settle_stable_ms = 2000U,
    .hook_timeout_ms = 5000U,
    .retract_timeout_ms = 5000U,
    .settle_timeout_ms = 5000U,
    .stair_theta_pid = {50.0f, 0.0f, 0.5f, 25.0f, 0.0f},
};
...
// ==== 基本运动（腿长档位）====
constexpr float kLowLegLengthM = 0.175f;              ///< 低腿长档位目标腿长 [m]
