...
constexpr float kIdentTheta[9] = {
  0.f, 0.f,  0.03675504, -0.26935183 * 1.9,  0.26007541* 1.9,
...
constexpr std::uint32_t kStairClimbPitchStableMs = 3000U;      ///< 上台阶完成后俯仰稳定等待时间 [ms]
...
-2.2194,  -15.05,  11.839,  22.271,  -9.5084,  -8.8983,
     -4.9508,  -23.388,  23.948,  39.22,  -26.013,  -16.462,
     -0.44597,  1.8042,  -0.65899,  -2.044,  0.30551,  0.95595,
     -2.2438,  9.2582,  -3.5363,  -10.276,  1.2678,  5.2206,
     -13.06,  -78.16,  13.227,  83.407,  -0.53579,  -16.966,
     -0.76712,  -5.2542,  2.1668,  -3.1819,  1.7717,  -2.5576,
     -4.4478,  9.1019,  -8.1942,  -5.2555,  3.632,  6.1059,
     -0.37607,  -0.69381,  -0.50945,  3.5617,  -7.4226,  1.4721,
     -26.411,  44.189,  32.315,  -10.209,  -37.229,  -29.286,
     -2.7264,  2.8873,  5.9259,  1.481,  -6.4542,  -5.6176,
     -2.2194,  11.839,  -15.05,  -8.8983,  -9.5084,  22.271,
     -4.9508,  23.948,  -23.388,  -16.462,  -26.013,  39.22,
     0.44597,  0.65899,  -1.8042,  -0.95595,  -0.30551,  2.044,
     2.2438,  3.5363,  -9.2582,  -5.2206,  -1.2678,  10.276,
     -4.4478,  -8.1942,  9.1019,  6.1059,  3.632,  -5.2555,
     -0.37607,  -0.50945,  -0.69381,  1.4721,  -7.4226,  3.5617,
     -13.06,  13.227,  -78.16,  -16.966,  -0.53579,  83.407,
     -0.76712,  2.1668,  -5.2542,  -2.5576,  1.7717,  -3.1819,
     -26.411,  32.315,  44.189,  -29.286,  -37.229,  -10.209,
     -2.7264,  5.9259,  2.8873,  -5.6176,  -6.4542,  1.481,
     4.7798,  2.4678,  -13.665,  -26.153,  26.483,  7.5811,
     9.6926,  2.4408,  -31.244,  -47.052,  60.071,  16.918,
     -0.41788,  -2.3918,  -1.0357,  4.1436,  -1.0758,  1.5408,
     -2.104,  -12.364,  -5.0539,  21.249,  -5.584,  7.4509,
     53.689,  -95.82,  11.211,  90.982,  37.516,  -25.881,
     2.5225,  -1.4129,  -1.0948,  3.3806,  4.5678,  -0.50942,
     -3.607,  -31.289,  -8.8882,  41.909,  -20.711,  -12.357,
     -0.21921,  -1.0071,  2.5469,  -2.3032,  1.805,  -7.514,
     -48.381,  -211.23,  74.116,  257.79,  28.267,  -96.882,
     -2.3034,  -16.585,  4.4171,  15.888,  7.8883,  -6.8152,
     4.7798,  -13.665,  2.4678,  7.5811,  26.483,  -26.153,
     9.6926,  -31.244,  2.4408,  16.918,  60.071,  -47.052,
     0.41788,  1.0357,  2.3918,  -1.5408,  1.0758,  -4.1436,
     2.104,  5.0539,  12.364,  -7.4509,  5.584,  -21.249,
     -3.607,  -8.8882,  -31.289,  -12.357,  -20.711,  41.909,
     -0.21921,  2.5469,  -1.0071,  -7.514,  1.805,  -2.3032,
     53.689,  11.211,  -95.82,  -25.881,  37.516,  90.982,
     2.5225,  -1.0948,  -1.4129,  -0.50942,  4.5678,  3.3806,
     -48.381,  74.116,  -211.23,  -96.882,  28.267,  257.79,
     -2.3034,  4.4171,  -16.585,  -6.8152,  7.8883,  15.888,
};
...
constexpr PidGains kLeftLegTurnPidManual{24.0f, 0.0f, 2.0f, 20.0f, 0.0f};   ///< 左腿摆角速度 PID（手动倒地恢复）
constexpr PidGains kRightLegTurnPidManual{24.0f, 0.0f, 2.0f, 20.0f, 0.0f};  ///< 右腿摆角速度 PID（手动倒地恢复）
...
constexpr float kTargetForwardSpeedMaxMps = 2.3f;        ///< 最大前进速度 [m/s]
...
constexpr float kYawFollowFixedTargetRad = -1.95f;      ///< 偏航跟随固定目标偏置角 [rad]（前进方向）
...
constexpr float kExpectedThetaLlBiasRadMidLeg = -0.1f;   ///< 中腿长期望左腿摆角偏置 [rad]
constexpr float kExpectedThetaLrBiasRadMidLeg = -0.1f;   ///< 中腿长期望右腿摆角偏置 [rad]
...
constexpr PidGains kYawPositionPid{90.0f, 0.2, 3.f, 1000.0f, 4.0f};     ///< 自瞄偏航位置 PID
constexpr PidGains kYawSpeedPid{0.7f, 0.0f, 0.0f, 10.0f, 0.3f};         ///< 自瞄偏航速度 PID
constexpr PidGains kPitchPositionPid{90.0f, 0.05f, 3.0f, 1000.0f, 1.5f};  ///< 自瞄俯仰位置 PID
constexpr PidGains kPitchSpeedPid{0.7f, 0.02f, 0.0f, 10.0f, 0.4f};        ///< 自瞄俯仰速度 PID
}  // namespace aimbot
...
constexpr float kMidLegLengthM = 0.215f;              ///< 中腿长档位目标腿长 [m]
...
// ==== 姿态安全/倒地恢复 ====
constexpr float kStandupThetaThresholdRad = 1.15f;  ///< 起立完成判定：双腿摆角绝对值低于此值后允许轮端输出 [rad]
constexpr float kPostureRollMinRad = -0.5f;          ///< 横滚角安全下限 [rad]
constexpr float kPostureRollMaxRad = 0.5f;           ///< 横滚角安全上限 [rad]
...
// ==== 基本运动（LQR 增益矩阵）====
constexpr std::array<float, 240> kCtrlP{
-3.7261,  -28.876,  23.39,  45.252,  -21.16,  -18.06,
     -7.1879,  -39.535,  39.391,  67.234,  -43.675,  -28.608,
     -0.35462,  1.6044,  -0.68327,  -1.4777,  -0.25743,  1.1216,
     -1.9541,  9.0343,  -4.0004,  -8.0914,  -1.7946,  6.6344,
     -14.752,  -94.914,  15.502,  91.227,  9.3601,  -21.486,
     -0.79489,  -7.5133,  3.2626,  -5.2555,  3.3697,  -4.0846,
     -4.1131,  0.74477,  -3.0565,  19.863,  -19.809,  -2.4347,
     -0.38667,  -2.1771,  -0.1865,  7.8282,  -14.314,  2.0935,
     -24.549,  31.683,  34.947,  4.1984,  -36.117,  -33.373,
     -2.9371,  1.7268,  7.6075,  3.673,  -7.6675,  -7.4146,
     -3.7261,  23.39,  -28.876,  -18.06,  -21.16,  45.252,
     -7.1879,  39.391,  -39.535,  -28.608,  -43.675,  67.234,
     0.35462,  0.68327,  -1.6044,  -1.1216,  0.25743,  1.4777,
     1.9541,  4.0004,  -9.0343,  -6.6344,  1.7946,  8.0914,
     -4.1131,  -3.0565,  0.74477,  -2.4347,  -19.809,  19.863,
     -0.38667,  -0.1865,  -2.1771,  2.0935,  -14.314,  7.8282,
     -14.752,  15.502,  -94.914,  -21.486,  9.3601,  91.227,
     -0.79489,  3.2626,  -7.5133,  -4.0846,  3.3697,  -5.2555,
     -24.549,  34.947,  31.683,  -33.373,  -36.117,  4.1984,
     -2.9371,  7.6075,  1.7268,  -7.4146,  -7.6675,  3.673,
     8.3292,  2.2018,  -18.221,  -48.62,  43.787,  12.149,
     14.375,  3.3111,  -39.037,  -78.209,  85.408,  24.154,
     -0.35732,  -2.1537,  -0.59591,  3.6501,  -0.98382,  1.0407,
     -1.972,  -12.223,  -3.0729,  20.554,  -5.6232,  5.4131,
     65.637,  -113.49,  5.8981,  90.426,  42.065,  -19.036,
     2.6067,  2.4254,  -2.271,  -4.1472,  7.4311,  0.61141,
     -3.1663,  -25.53,  -1.1077,  22.105,  -30.273,  3.7413,
     -0.16596,  0.6545,  3.7718,  -7.5636,  1.3843,  -4.8506,
     -36.737,  -195.87,  59.156,  229.59,  36.63,  -81.883,
     -1.3476,  -16.691,  2.3283,  13.925,  10.86,  -5.1501,
     8.3292,  -18.221,  2.2018,  12.149,  43.787,  -48.62,
     14.375,  -39.037,  3.3111,  24.154,  85.408,  -78.209,
     0.35732,  0.59591,  2.1537,  -1.0407,  0.98382,  -3.6501,
     1.972,  3.0729,  12.223,  -5.4131,  5.6232,  -20.554,
     -3.1663,  -1.1077,  -25.53,  3.7413,  -30.273,  22.105,
     -0.16596,  3.7718,  0.6545,  -4.8506,  1.3843,  -7.5636,
     65.637,  5.8981,  -113.49,  -19.036,  42.065,  90.426,
     2.6067,  -2.271,  2.4254,  0.61141,  7.4311,  -4.1472,
     -36.737,  59.156,  -195.87,  -81.883,  36.63,  229.59,
     -1.3476,  2.3283,  -16.691,  -5.1501,  10.86,  13.925,
};
...
// ==== 基本运动 ====
constexpr float kTargetForwardSpeedMaxMps = 2.25f;         ///< 最大前进速度 [m/s]
...
constexpr PidGains kYawFollowPid{15.0f, 0.0f, 2.f, 6.0f, 0.0f};  ///< 偏航跟随 PID
...
// ==== 基本运动（LQR 增益矩阵）====
constexpr std::array<float, 240> kCtrlP{
    -2.9998,  -24.644, 19.872,   40.231,  -19.053,  -15.526, -5.734,   -34.251,  33.278,   59.483,  -37.138,  -24.851,
    -0.41238, 2.0357,  -0.73092, -1.9266, -0.13533, 1.2566,  -1.3272,  6.7877,   -2.6507,  -6.152,  -0.80589, 4.6125,
    -12.347,  -78.645, 14.062,   75.242,  4.9305,   -19.215, -0.77411, -6.3968,  2.7821,   -3.8891, 2.4327,   -3.5051,
    -3.5741,  0.90287, -2.0048,  15.52,   -17.797,  2.2754,  -0.33111, -1.8635,  0.048705, 6.7186,  -11.88,   1.7319,
    -22.698,  35.036,  29.293,   -5.9988, -29.89,   -29.181, -2.6958,  2.1051,   6.4845,   2.6144,  -6.4567,  -6.552,
    -2.9998,  19.872,  -24.644,  -15.526, -19.053,  40.231,  -5.734,   33.278,   -34.251,  -24.851, -37.138,  59.483,
    0.41238,  0.73092, -2.0357,  -1.2566, 0.13533,  1.9266,  1.3272,   2.6507,   -6.7877,  -4.6125, 0.80589,  6.152,
    -3.5741,  -2.0048, 0.90287,  2.2754,  -17.797,  15.52,   -0.33111, 0.048705, -1.8635,  1.7319,  -11.88,   6.7186,
    -12.347,  14.062,  -78.645,  -19.215, 4.9305,   75.242,  -0.77411, 2.7821,   -6.3968,  -3.5051, 2.4327,   -3.8891,
    -22.698,  29.293,  35.036,   -29.181, -29.89,   -5.9988, -2.6958,  6.4845,   2.1051,   -6.552,  -6.4567,  2.6144,
    6.4194,   -4.0486, -10.087,  -31.77,  33.928,   7.0646,  11.035,   -5.6817,  -24.233,  -51.879, 64.408,   16.514,
    -0.43069, -2.5493, -0.69619, 4.4006,  -0.96315, 1.3069,  -1.3815,  -8.68,    -2.0743,  14.877,  -3.5492,  4.0105,
    46.433,   -77.622, 5.3882,   54.347,  34.843,   -16.752, 2.3027,   0.27668,  -1.4785,  -3.3609, 7.4569,   0.11583,
    -2.4768,  -22.767, -1.2052,  21.454,  -20.35,   7.0444,  -0.14919, -0.161,   3.0362,   -4.5024, -0.96959, -2.0544,
    -36.806,  -167.99, 53.647,   206.04,  29.33,    -78.712, -1.7236,  -15.7,    3.5368,   14.955,  8.3488,   -6.4904,
    6.4194,   -10.087, -4.0486,  7.0646,  33.928,   -31.77,  11.035,   -24.233,  -5.6817,  16.514,  64.408,   -51.879,
    0.43069,  0.69619, 2.5493,   -1.3069, 0.96315,  -4.4006, 1.3815,   2.0743,   8.68,     -4.0105, 3.5492,   -14.877,
    -2.4768,  -1.2052, -22.767,  7.0444,  -20.35,   21.454,  -0.14919, 3.0362,   -0.161,   -2.0544, -0.96959, -4.5024,
    46.433,   5.3882,  -77.622,  -16.752, 34.843,   54.347,  2.3027,   -1.4785,  0.27668,  0.11583, 7.4569,   -3.3609,
    -36.806,  53.647,  -167.99,  -78.712, 29.33,    206.04,  -1.7236,  3.5368,   -15.7,    -6.4904, 8.3488,   14.955,
};

// ==== 基本运动（PID 增益）====
constexpr PidGains kLeftL0Pid{3000.0f, 0.f, 200.0f, 180.0f, 30.0f};   ///< 左腿腿长 PID（常规）
constexpr PidGains kRightL0Pid{3000.0f, 0.f, 200.0f, 180.0f, 30.0f};  ///< 右腿腿长 PID（常规）
...
constexpr PidGains kLeftLegTurnPidManual{16.0f, 0.0f, 0.0f, 12.0f, 0.0f};   ///< 左腿摆角速度 PID（手动倒地恢复）
constexpr PidGains kRightLegTurnPidManual{16.0f, 0.0f, 0.0f, 12.0f, 0.0f};  ///< 右腿摆角速度 PID（手动倒地恢复）
...
// constexpr float kRightPhi1OffsetRad = 1.38f + M_PI -2.08f;  ///< 右腿前关节零位偏移 [rad]
// constexpr float kRightPhi4OffsetRad = 0.86f - 2.5f;         ///< 右腿后关节零位偏移 [rad]
