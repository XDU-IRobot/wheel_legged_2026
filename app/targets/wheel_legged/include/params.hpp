...
struct FallDetectorParams {
  ...
  float inverted_tilt_cos;           ///< 倒扣判定 cos(tilt) [1]，低于此值判定为倒扣
};
...
constexpr PostureObserverParams kParams{
    ...
    .R_bs_00 = 0.0f, .R_bs_01 = -1.0f, .R_bs_02 = 0.0f,
    .R_bs_10 = 1.0f, .R_bs_11 = 0.0f, .R_bs_12 = 0.0f,
    .R_bs_20 = 0.0f, .R_bs_21 = 0.0f, .R_bs_22 = 1.0f,
...
constexpr FallDetectorParams kParams{
    ...
    .inverted_tilt_cos = -0.94f,         // cos(160°)
};
}  // namespace fall_detector
