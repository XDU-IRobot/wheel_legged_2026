...
constexpr float kPostureThetaLegMaxRad = 2.3f;          ///< 腿摆角安全上限 [rad]
...
constexpr PidGains kLeftLegAnglePidStandup{30.0f, 0.0f, 0.f, 15.0f, 0.0f};   ///< 左腿摆角 PID（起立用）
constexpr PidGains kRightLegAnglePidStandup{30.0f, 0.0f, 0.f, 15.0f, 0.0f};  ///< 右腿摆角 PID（起立用）
...
constexpr float kSpinThetaLrBiasRad = -0.04f;  ///< 小陀螺时右腿摆角偏置 [rad]
constexpr float kSpinLegLengthBiasM = 0.0f;    ///< 小陀螺时腿长偏差（左+右-）[m]
