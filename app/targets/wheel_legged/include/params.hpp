...
constexpr std::uint16_t kAutoJumpTriggerDistanceMm = 950U;  // 最大距离
...
constexpr float kSpinThetaLrBiasRad = 0.05f;   ///< 小陀螺时右腿摆角偏置 [rad]
constexpr float kSpinLegLengthBiasM = -0.00f;  ///< 小陀螺时腿长偏差（左+右-）[m]
...
constexpr PidGains kPitchPositionPidRune{45.0f, 0.f, 0.5f, 10.0f, 2.f};  ///< 自瞄俯仰位置 PID（打符）
