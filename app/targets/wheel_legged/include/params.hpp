...
struct StairClimbParams {
  ...
  float retract_length_tolerance;
...
constexpr float kRecoveryMinSpeedRadS = 0.08f;  ///< 恢复减速区边界最低速度 [rad/s]
constexpr float kRecoveryGravityRampScale = 0.35f;   ///< 恢复时重力补偿斜坡比例（越大身体越不砸）
constexpr float kRecoveryPitchFeedforwardKp = 0.f;  ///< 倒地恢复俯仰角前馈系数
...
// ==== 倒地自启（腿摆速度 PID）====
constexpr PidGains kLeftLegTurnPid{15.0f, 0.f, 20.0f, 10.0f, 0.0f};         ///< 左腿摆角速度 PID
constexpr PidGains kRightLegTurnPid{15.0f, 0.f, 20.0f, 10.0f, 0.0f};        ///< 右腿摆角速度 PID
...
constexpr float kYawFollowFixedTargetRad = -2.269f+1.5707f;              ///< 偏航跟随固定目标偏置角 [rad]
...
constexpr float kRecoveryMinSpeedRadS = 0.08f;  ///< 恢复减速区边界最低速度 [rad/s]
constexpr float kRecoveryGravityRampScale = 0.35f;   ///< 恢复时重力补偿斜坡比例（越大身体越不砸）
constexpr float kRecoveryPitchFeedforwardKp = 22.0f;  ///< 倒地恢复俯仰角前馈系数
...
// ==== 基本运动（LQR 增益矩阵）====
constexpr std::array<float, 240> kCtrlPLow{
   -3.7003,  -32.658,  26.851,  57.071,  -29.467,  -20.706,
     -7.3537,  -49.522,  46.851,  89.745,  -55.92,  -35.276,
     -0.48706,  2.7232,  -1.0329,  -2.2264,  -0.86309,  1.9634,
     -1.1203,  6.64,  -2.847,  -4.9958,  -2.662,  5.4314,
     -15.265,  -90.636,  17.081,  82.696,  9.7736,  -23.941,
     -0.92096,  -8.5805,  3.7768,  -4.5345,  3.1798,  -4.8058,
     -3.4428,  -7.2725,  3.8084,  39.644,  -41.501,  -4.3741,
     -0.32669,  -3.4108,  0.50115,  11.153,  -18.137,  2.0735,
     -26.093,  40.919,  33.363,  -11.05,  -30.866,  -34.749,
     -3.0901,  1.8816,  7.9155,  3.7484,  -7.5351,  -8.1635,
     -3.7003,  26.851,  -32.658,  -20.706,  -29.467,  57.071,
     -7.3537,  46.851,  -49.522,  -35.276,  -55.92,  89.745,
     0.48706,  1.0329,  -2.7232,  -1.9634,  0.86309,  2.2264,
     1.1203,  2.847,  -6.64,  -5.4314,  2.662,  4.9958,
     -3.4428,  3.8084,  -7.2725,  -4.3741,  -41.501,  39.644,
     -0.32669,  0.50115,  -3.4108,  2.0735,  -18.137,  11.153,
     -15.265,  17.081,  -90.636,  -23.941,  9.7736,  82.696,
     -0.92096,  3.7768,  -8.5805,  -4.8058,  3.1798,  -4.5345,
     -26.093,  33.363,  40.919,  -34.749,  -30.866,  -11.05,
     -3.0901,  7.9155,  1.8816,  -8.1635,  -7.5351,  3.7484,
     6.9487,  -11.39,  -3.8337,  -29.238,  36.741,  2.609,
     12.525,  -15.705,  -16.729,  -53.688,  71.538,  12.477,
     -0.55369,  -2.934,  -0.46655,  5.2431,  -1.5054,  1.444,
     -1.2667,  -7.4253,  -0.84174,  13.173,  -4.2907,  3.1872,
     48.497,  -89.481,  4.3563,  56.088,  45.745,  -17.029,
     2.3777,  0.76163,  -1.5819,  -7.8138,  11.124,  -0.018103,
     -2.7771,  -19.222,  8.6522,  11.647,  -34.06,  18.773,
     -0.16322,  0.39174,  3.9918,  -6.1151,  -4.2512,  1.6724,
     -40.35,  -170.59,  53.972,  213.59,  30.394,  -83.717,
     -1.7579,  -16.244,  3.6395,  15.547,  8.9098,  -7.1084,
     6.9487,  -3.8337,  -11.39,  2.609,  36.741,  -29.238,
     12.525,  -16.729,  -15.705,  12.477,  71.538,  -53.688,
     0.55369,  0.46655,  2.934,  -1.444,  1.5054,  -5.2431,
     1.2667,  0.84174,  7.4253,  -3.1872,  4.2907,  -13.173,
     -2.7771,  8.6522,  -19.222,  18.773,  -34.06,  11.647,
     -0.16322,  3.9918,  0.39174,  1.6724,  -4.2512,  -6.1151,
     48.497,  4.3563,  -89.481,  -17.029,  45.745,  56.088,
     2.3777,  -1.5819,  0.76163,  -0.018103,  11.124,  -7.8138,
     -40.35,  53.972,  -170.59,  -83.717,  30.394,  213.59,
     -1.7579,  3.6395,  -16.244,  -7.1084,  8.9098,  15.547,
};
constexpr std::array<float, 240> kCtrlPMid{
...
// ==== 倒地自启（腿摆速度 PID）====
constexpr PidGains kLeftLegTurnPid{18.0f, 0.f, 20.0f, 10.0f, 10.0f};   ///< 左腿摆角速度 PID
constexpr PidGains kRightLegTurnPid{18.0f, 0.f, 20.0f, 10.0f, 10.0f};  ///< 右腿摆角速度 PID
constexpr PidGains kLeftLegTurnPidManual{10.0f, 0.0f, 2.0f, 20.0f, 0.0f};  ///< 左腿摆角速度 PID（手动倒地恢复）
constexpr PidGains kRightLegTurnPidManual{10.0f, 0.0f, 2.0f, 20.0f, 0.0f};  ///< 右腿摆角速度 PID（手动倒地恢复）
...
constexpr float kTargetForwardSpeedMaxHighLegMps = 1.2f;  ///< 高腿长模式最大前进速度 [m/s]
constexpr float kTargetForwardSpeedMaxMidLegMps = 1.0f;   ///< F键中腿长模式最大前进速度 [m/s]
constexpr float kTargetSpeedBiasLowLegMps = -0.01f;        ///< 低腿长目标速度偏置 [m/s]
constexpr float kTargetSpeedBiasMidLegMps = 0.f;          ///< C键中腿长目标速度偏置 [m/s]
constexpr float kTargetSpeedBiasMidLegFMps = 0.f;         ///< F键中腿长目标速度偏置 [m/s]
constexpr float kTargetSpeedBiasHighLegMps = -0.1f;        ///< 高腿长目标速度偏置 [m/s]
...
constexpr float kExpectedDisplacementBiasMMidLeg = 0.28f;  ///< 中腿长期望位移偏置 [m]
