...
constexpr float kJumpLowPushLegLengthM = 0.33f;         ///< 跳跃蹬伸阶段目标腿长 [m]
...
// ==== 跳跃（PID 增益）====
constexpr float kJumpPushForceN = 230.0f;                                     ///< 蹬伸阶段单腿基础支撑力 [N]
...
// ==== 速度斜坡参数 ====
constexpr SdotRampParams kSdotRampLowLeg{0.005f, 0.005f};   ///< 低腿长速度斜坡
