...
constexpr float kStairClimbThetaTargetRad = 1.1f;                  ///< 上台阶目标腿摆角（统一偏置） [rad]
constexpr std::uint32_t kStairClimbDurationMs = 1000U;             ///< 上台阶最长持续时间 [ms]
...
constexpr std::uint32_t kStairClimbPitchStableMs = 400U;      ///< 上台阶完成后俯仰稳定等待时间 [ms]
...
constexpr float kSpringTorqueScale = 100.0f;  ///< 弹簧力矩缩放系数（调参用）

// ==== 基本运动（横滚平衡）====
constexpr float kRollBalanceTargetRad = 0.025f;  ///< 横滚平衡目标角 [rad]
...
constexpr std::array<float, 240> kCtrlP{
    -1.9402,  -15.495, 11.384,  22.072,  -7.0165,  -10.467, -4.1924,  -25.735,  22.349,   38.759,   -18.259,  -19.566,
    -0.81493, 3.0117,  -1.4038, -3.0756, 0.18136,  1.9472,  -2.3306,  8.8271,   -4.2864,  -8.7386,  0.20353,  6.045,
    -8.06,    -69.804, 15.334,  57,      9.2054,   -21.493, -0.56472, -5.3896,  2.295,    -4.2007,  2.7339,   -3.2817,
    -3.3729,  0.9483,  -9.8559, 12.88,   -4.3214,  2.3679,  -0.30702, -1.3717,  -0.35598, 4.6654,   -7.8988,  0.064015,
    -19.794,  17.98,   30.942,  17.412,  -33.769,  -25.841, -2.4039,  1.2428,   5.8829,   3.1708,   -5.7277,  -5.6283,
    -1.9402,  11.384,  -15.495, -10.467, -7.0165,  22.072,  -4.1924,  22.349,   -25.735,  -19.566,  -18.259,  38.759,
    0.81493,  1.4038,  -3.0117, -1.9472, -0.18136, 3.0756,  2.3306,   4.2864,   -8.8271,  -6.045,   -0.20353, 8.7386,
    -3.3729,  -9.8559, 0.9483,  2.3679,  -4.3214,  12.88,   -0.30702, -0.35598, -1.3717,  0.064015, -7.8988,  4.6654,
    -8.06,    15.334,  -69.804, -21.493, 9.2054,   57,      -0.56472, 2.295,    -5.3896,  -3.2817,  2.7339,   -4.2007,
    -19.794,  30.942,  17.98,   -25.841, -33.769,  17.412,  -2.4039,  5.8829,   1.2428,   -5.6283,  -5.7277,  3.1708,
    6.8646,   8.7782,  -21.565, -44.165, 33.503,   15.777,  13.484,   13.837,   -44.916,  -79.761,  72.893,   31.057,
    -0.69815, -5.8863, -1.765,  10.199,  -3.3906,  2.7713,  -2.0007,  -17.428,  -4.7187,  29.837,   -10.038,  7.3458,
    49.906,   -40.717, 2.459,   6.4186,  61.538,   -16.382, 2.5998,   3.5488,   -2.504,   -2.2296,  5.2062,   1.3714,
    -1.2429,  -29.885, -9.0078, 27.502,  -48.812,  3.7073,  -0.16138, 0.78265,  3.6273,   -7.328,   1.5367,   -7.2088,
    -31.113,  -188.28, 47.44,   193.34,  49.216,   -60.582, -1.0108,  -16.127,  1.0221,   11.336,   11.268,   -2.6117,
    6.8646,   -21.565, 8.7782,  15.777,  33.503,   -44.165, 13.484,   -44.916,  13.837,   31.057,   72.893,   -79.761,
    0.69815,  1.765,   5.8863,  -2.7713, 3.3906,   -10.199, 2.0007,   4.7187,   17.428,   -7.3458,  10.038,   -29.837,
    -1.2429,  -9.0078, -29.885, 3.7073,  -48.812,  27.502,  -0.16138, 3.6273,   0.78265,  -7.2088,  1.5367,   -7.328,
    49.906,   2.459,   -40.717, -16.382, 61.538,   6.4186,  2.5998,   -2.504,   3.5488,   1.3714,   5.2062,   -2.2296,
    -31.113,  47.44,   -188.28, -60.582, 49.216,   193.34,  -1.0108,  1.0221,   -16.127,  -2.6117,  11.268,   11.336,
};
...
constexpr float kSpinThetaBBiasRad = -0.123f;  ///< 小陀螺时期望机体俯仰偏置 [rad]
...
constexpr float kStairClimbThetaNearZeroThresholdRad = 0.05f;  ///< 摆角归零判定阈值（上台阶完成） [rad]
constexpr std::uint32_t kStairClimbPitchStableMs = 350U;     ///< 上台阶完成后俯仰稳定等待时间 [ms]
...
// ==== 基本运动（LQR 增益矩阵）====
constexpr std::array<float, 240> kCtrlP{
            -1.079,  -9.1961,  7.272,  14.324,  -6.6837,  -5.5964,
            -3.5981,  -24.639,  22.08,  40.177,  -22.841,  -16.469,
            -0.34287,  1.5322,  -0.64319,  -1.3415,  -0.076678,  1.0405,
            -1.1068,  5.1366,  -2.3294,  -4.2627,  -0.60094,  3.8433,
            -9.4933,  -74.217,  11.705,  72.516,  4.9291,  -16.203,
            -0.58851,  -5.0552,  2.0393,  -3.4557,  2.113,  -2.6648,
            -3.011,  0.46132,  -3.2572,  13.813,  -10.503,  1.2373,
            -0.27466,  -1.3308,  0.055501,  4.7754,  -8.4338,  0.91816,
            -18.57,  19.785,  27.18,  11.783,  -26.99,  -26.406,
            -2.2624,  1.3443,  5.426,  2.8251,  -5.2025,  -5.4261,
            -1.079,  7.272,  -9.1961,  -5.5964,  -6.6837,  14.324,
            -3.5981,  22.08,  -24.639,  -16.469,  -22.841,  40.177,
            0.34287,  0.64319,  -1.5322,  -1.0405,  0.076678,  1.3415,
            1.1068,  2.3294,  -5.1366,  -3.8433,  0.60094,  4.2627,
            -3.011,  -3.2572,  0.46132,  1.2373,  -10.503,  13.813,
            -0.27466,  0.055501,  -1.3308,  0.91816,  -8.4338,  4.7754,
            -9.4933,  11.705,  -74.217,  -16.203,  4.9291,  72.516,
            -0.58851,  2.0393,  -5.0552,  -2.6648,  2.113,  -3.4557,
            -18.57,  27.18,  19.785,  -26.406,  -26.99,  11.783,
            -2.2624,  5.426,  1.3443,  -5.4261,  -5.2025,  2.8251,
            3.2234,  1.3652,  -7.1106,  -20.744,  17.154,  5.423,
            10.036,  3.2729,  -25.376,  -60.48,  57.471,  18.32,
            -0.34383,  -2.7046,  -0.68572,  4.5283,  -1.223,  1.2853,
            -1.108,  -9.2389,  -1.9553,  15.327,  -4.363,  3.7964,
            54.093,  -76.389,  6.3114,  33.196,  37.912,  -18.198,
            2.4189,  1.4025,  -1.4256,  -3.8825,  6.3508,  0.23943,
            -1.7874,  -26.017,  -3.7766,  23.537,  -26.566,  13.603,
            -0.18316,  0.33009,  2.9681,  -5.5326,  -0.47196,  -2.4135,
            -28.635,  -175.29,  50.236,  199.6,  37.068,  -73.216,
            -1.32,  -15.826,  3.1822,  13.845,  8.7165,  -5.8682,
            3.2234,  -7.1106,  1.3652,  5.423,  17.154,  -20.744,
            10.036,  -25.376,  3.2729,  18.32,  57.471,  -60.48,
            0.34383,  0.68572,  2.7046,  -1.2853,  1.223,  -4.5283,
            1.108,  1.9553,  9.2389,  -3.7964,  4.363,  -15.327,
            -1.7874,  -3.7766,  -26.017,  13.603,  -26.566,  23.537,
            -0.18316,  2.9681,  0.33009,  -2.4135,  -0.47196,  -5.5326,
            54.093,  6.3114,  -76.389,  -18.198,  37.912,  33.196,
            2.4189,  -1.4256,  1.4025,  0.23943,  6.3508,  -3.8825,
            -28.635,  50.236,  -175.29,  -73.216,  37.068,  199.6,
            -1.32,  3.1822,  -15.826,  -5.8682,  8.7165,  13.845,
};
...
constexpr float kExpectedThetaLlBiasRadHighLeg = 0.05f;  ///< 高腿长期望左腿摆角偏置 [rad]
constexpr float kExpectedThetaLrBiasRadHighLeg = 0.05f;  ///< 高腿长期望右腿摆角偏置 [rad]
constexpr float kExpectedThetaBBiasRad =-0.07f;           ///< 期望机体俯仰偏置 [rad]
...
constexpr float kSpinThetaBBiasRad = 0.0f;  ///< 小陀螺时期望机体俯仰偏置 [rad]
...
// ==== 基本运动（LQR 增益矩阵）====
constexpr std::array<float, 240> kCtrlP{
    -1.0835,  -9.1623, 7.2995,   14.273,  -6.7305,   -5.6257, -3.6115,  -24.535,  22.151,   40.014,  -22.961,  -16.546,
    -0.34287, 1.532,   -0.64306, -1.3407, -0.076066, 1.0392,  -1.1068,  5.1358,   -2.3285,  -4.2599, -0.59916, 3.8387,
    -9.3708,  -74.437, 11.523,   72.567,  5.0874,    -16.001, -0.58398, -5.0571,  2.0363,   -3.4607, 2.1148,   -2.6623,
    -2.8884,  0.21786, -3.4161,  13.929,  -10.295,   1.3243,  -0.27022, -1.3322,  0.052748, 4.7647,  -8.4348,  0.92813,
    -17.311,  17.577,  25.882,   12.274,  -25.454,   -25.277, -2.2014,  1.2355,   5.3481,   2.858,   -5.1208,  -5.3499,
    -1.0835,  7.2995,  -9.1623,  -5.6257, -6.7305,   14.273,  -3.6115,  22.151,   -24.535,  -16.546, -22.961,  40.014,
    0.34287,  0.64306, -1.532,   -1.0392, 0.076066,  1.3407,  1.1068,   2.3285,   -5.1358,  -3.8387, 0.59916,  4.2599,
    -2.8884,  -3.4161, 0.21786,  1.3243,  -10.295,   13.929,  -0.27022, 0.052748, -1.3322,  0.92813, -8.4348,  4.7647,
    -9.3708,  11.523,  -74.437,  -16.001, 5.0874,    72.567,  -0.58398, 2.0363,   -5.0571,  -2.6623, 2.1148,   -3.4607,
    -17.311,  25.882,  17.577,   -25.277, -25.454,   12.274,  -2.2014,  5.3481,   1.2355,   -5.3499, -5.1208,  2.858,
    3.1961,   1.5396,  -6.9535,  -20.939, 16.968,    5.2198,  9.9349,   3.8112,   -24.835,  -61.056, 56.843,   17.634,
    -0.34384, -2.7078, -0.6825,  4.5401,  -1.2276,   1.2779,  -1.108,   -9.2496,  -1.9448,  15.362,  -4.3757,  3.7741,
    54.335,   -75.377, 5.7181,   31.488,  37.621,    -17.277, 2.4228,   1.4713,   -1.412,   -3.9137, 6.3277,   0.21754,
    -1.5453,  -25.112, -4.2655,  22.511,  -27.081,   14.075,  -0.17894, 0.40961,  2.968,    -5.6375, -0.47411, -2.3773,
    -25.326,  -163.28, 45.411,   184.24,  35.524,    -66.179, -1.194,   -15.308,  2.9266,   13.185,  8.6024,   -5.4973,
    3.1961,   -6.9535, 1.5396,   5.2198,  16.968,    -20.939, 9.9349,   -24.835,  3.8112,   17.634,  56.843,   -61.056,
    0.34384,  0.6825,  2.7078,   -1.2779, 1.2276,    -4.5401, 1.108,    1.9448,   9.2496,   -3.7741, 4.3757,   -15.362,
    -1.5453,  -4.2655, -25.112,  14.075,  -27.081,   22.511,  -0.17894, 2.968,    0.40961,  -2.3773, -0.47411, -5.6375,
    54.335,   5.7181,  -75.377,  -17.277, 37.621,    31.488,  2.4228,   -1.412,   1.4713,   0.21754, 6.3277,   -3.9137,
    -25.326,  45.411,  -163.28,  -66.179, 35.524,    184.24,  -1.194,   2.9266,   -15.308,  -5.4973, 8.6024,   13.185,
};
...
constexpr float kSpinThetaBBiasRad = -0.02f;  ///< 小陀螺时期望机体俯仰偏置 [rad]
