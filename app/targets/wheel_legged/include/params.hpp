...
// ==== 上台阶（腿摆角 PID）====
constexpr PidGains kStairClimbThetaPid{15.0f, 0.0f, 10.0f, 20.0f,
...
// ==== 基本运动（LQR 增益矩阵）====
constexpr std::array<float, 240> kCtrlP{
-3.156,  -26.078,  19.489,  38.894,  -14.614,  -16.358,
     -4.8855,  -28.769,  26.383,  45.648,  -25.348,  -21.103,
     -0.48019,  1.9634,  -0.88925,  -1.9148,  0.036984,  1.3361,
     -1.8789,  7.839,  -3.6775,  -7.4573,  -0.074459,  5.5834,
     -8.542,  -69.099,  17.327,  57.018,  6.9255,  -23.58,
     -0.67145,  -5.7299,  2.5187,  -3.6545,  2.576,  -3.3613,
     -3.7581,  1.5863,  -8.5756,  12.444,  -10.415,  8.1983,
     -0.34498,  -1.3825,  -0.24727,  5.0886,  -9.1731,  0.91807,
     -24.189,  28.576,  35.503,  11.423,  -39.25,  -30.68,
     -2.6655,  1.7275,  6.4435,  3.153,  -6.4719,  -6.1974,
     -3.156,  19.489,  -26.078,  -16.358,  -14.614,  38.894,
     -4.8855,  26.383,  -28.769,  -21.103,  -25.348,  45.648,
     0.48019,  0.88925,  -1.9634,  -1.3361,  -0.036984,  1.9148,
     1.8789,  3.6775,  -7.839,  -5.5834,  0.074459,  7.4573,
     -3.7581,  -8.5756,  1.5863,  8.1983,  -10.415,  12.444,
     -0.34498,  -0.24727,  -1.3825,  0.91807,  -9.1731,  5.0886,
     -8.542,  17.327,  -69.099,  -23.58,  6.9255,  57.018,
     -0.67145,  2.5187,  -5.7299,  -3.3613,  2.576,  -3.6545,
     -24.189,  35.503,  28.576,  -30.68,  -39.25,  11.423,
     -2.6655,  6.4435,  1.7275,  -6.1974,  -6.4719,  3.153,
     10.176,  6.2538,  -28.522,  -59.579,  52.04,  21.452,
     14.014,  6.0566,  -44.054,  -74.026,  79.631,  31.145,
     -0.43461,  -3.5376,  -1.0111,  5.9916,  -1.8125,  1.6662,
     -1.6998,  -14.249,  -3.7726,  23.966,  -7.3837,  6.2056,
     44.019,  -38.357,  2.7475,  3.4064,  57.154,  -17.402,
     2.8116,  1.5389,  -2.4761,  -2.287,  6.3721,  1.194,
     -1.3447,  -31.432,  -8.7413,  28.378,  -32.438,  3.4766,
     -0.1104,  -0.010058,  3.2314,  -5.9991,  1.3782,  -5.8983,
     -45.406,  -222.45,  67.134,  247.7,  50.862,  -92.442,
     -1.633,  -18.02,  2.4947,  14.668,  11.471,  -4.9979,
     10.176,  -28.522,  6.2538,  21.452,  52.04,  -59.579,
     14.014,  -44.054,  6.0566,  31.145,  79.631,  -74.026,
     0.43461,  1.0111,  3.5376,  -1.6662,  1.8125,  -5.9916,
     1.6998,  3.7726,  14.249,  -6.2056,  7.3837,  -23.966,
     -1.3447,  -8.7413,  -31.432,  3.4766,  -32.438,  28.378,
     -0.1104,  3.2314,  -0.010058,  -5.8983,  1.3782,  -5.9991,
     44.019,  2.7475,  -38.357,  -17.402,  57.154,  3.4064,
     2.8116,  -2.4761,  1.5389,  1.194,  6.3721,  -2.287,
     -45.406,  67.134,  -222.45,  -92.442,  50.862,  247.7,
     -1.633,  2.4947,  -18.02,  -4.9979,  11.471,  14.668,
};
...
constexpr float kYawFollowRampStepRadS = 0.05f;            ///< 偏航跟随角速度斜坡步长 [(rad/s)/周期]
constexpr float kPositionFreezeSpeedThresholdMps = 0.5f;  ///< 位置锚定冻结速度阈值 [m/s]
...
// ==== 小陀螺 ====
constexpr float kSpinYawRampStepRadS = 0.07f;  ///< 小陀螺偏航角速度斜坡步长 [(rad/s)/周期]
constexpr float kSpinTargetYawDotRadS = 10.0f;  ///< 小陀螺目标自旋角速度 [rad/s]
