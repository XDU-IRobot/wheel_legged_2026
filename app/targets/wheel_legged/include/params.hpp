...
constexpr float kIdentTheta[9] = {
    // 0.f, 0.f,  0.03675504, 0.26935183 * 0.5,  -0.26007541 *0.5,
...
constexpr StairClimbParams kStairClimb{
    ...
    .theta_pid = {21.0f, 0.0f, 8.0f, 15.0f, 0.0f},
};
...
// ==== 倒地自启（腿摆速度 PID）====
constexpr PidGains kLeftLegTurnPid{30.0f, 0.0f, 50.0f, 24.0f, 0.0f};   ///< 左腿摆角速度 PID（倒地恢复用）
constexpr PidGains kRightLegTurnPid{30.0f, 0.0f, 50.0f, 24.0f, 0.0f};  ///< 右腿摆角速度 PID（倒地恢复用）
constexpr PidGains kLeftLegTurnPidManual{30.0f, 0.0f, 50.0f, 24.0f, 0.0f};  ///< 左腿摆角速度 PID（手动倒地恢复）
constexpr PidGains kRightLegTurnPidManual{30.0f, 0.0f, 50.0f, 24.0f, 0.0f};  ///< 右腿摆角速度 PID（手动倒地恢复）
...
constexpr PidGains kPitchPositionPid{52, 0.0f, 0.0f, 8.0f, 4.f};  ///< 自瞄俯仰位置 PID
