...
constexpr float kRecoveryPitchFeedforwardKp = 20.0f;  ///< 倒地恢复俯仰角前馈系数
...
constexpr float kTargetForwardSpeedMaxMps = 2.51f;        ///< 最大前进速度 [m/s]
...
constexpr SdotRampParams kSdotRampMidLegF{0.0045f, 0.0045f};  ///< 中腿长速度斜坡（G 键触发）
