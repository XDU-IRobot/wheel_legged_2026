...
// ==== 姿态安全/倒地恢复 ====
constexpr float kStandupThetaThresholdRad = 1.20f;  ///< 起立完成判定：双腿摆角绝对值低于此值后允许轮端输出 [rad]
constexpr float kPostureRollMinRad = -0.5f;          ///< 横滚角安全下限 [rad]
constexpr float kPostureRollMaxRad = 0.5f;           ///< 横滚角安全上限 [rad]
...
constexpr float kSpringTorqueScale = 75.0f;  ///< 弹簧力矩缩放系数
...
// ==== 基本运动（LQR 增益矩阵）====
constexpr std::array<float, 240> kCtrlP{
            -1.4132,  -12.643,  9.7588,  19.529,  -8.8504,  -7.5089,
            -3.528,  -23.815,  21.516,  38.841,  -22.543,  -15.959,
            -0.32738,  1.4544,  -0.64053,  -1.2513,  -0.073557,  1.0348,
            -1.0582,  4.8714,  -2.2991,  -3.9844,  -0.54187,  3.779,
            -8.3927,  -69.63,  12.395,  66.118,  4.6485,  -16.946,
            -0.56056,  -4.8084,  2.0292,  -3.2342,  1.9662,  -2.6176,
            -3.0648,  0.89672,  -4.3002,  12.271,  -10.039,  4.053,
            -0.28156,  -1.2235,  0.058574,  4.5168,  -8.0255,  0.95453,
            -18.932,  19.116,  28.488,  14.882,  -29.04,  -26.969,
            -2.2593,  1.2858,  5.4616,  3.0068,  -5.3096,  -5.4121,
            -1.4132,  9.7588,  -12.643,  -7.5089,  -8.8504,  19.529,
            -3.528,  21.516,  -23.815,  -15.959,  -22.543,  38.841,
            0.32738,  0.64053,  -1.4544,  -1.0348,  0.073557,  1.2513,
            1.0582,  2.2991,  -4.8714,  -3.779,  0.54187,  3.9844,
            -3.0648,  -4.3002,  0.89672,  4.053,  -10.039,  12.271,
            -0.28156,  0.058574,  -1.2235,  0.95453,  -8.0255,  4.5168,
            -8.3927,  12.395,  -69.63,  -16.946,  4.6485,  66.118,
            -0.56056,  2.0292,  -4.8084,  -2.6176,  1.9662,  -3.2342,
            -18.932,  28.488,  19.116,  -26.969,  -29.04,  14.882,
            -2.2593,  5.4616,  1.2858,  -5.4121,  -5.3096,  3.0068,
            4.8003,  2.0218,  -11.002,  -30.615,  25.742,  8.347,
            10.942,  3.2249,  -29.325,  -64.084,  63.909,  21.003,
            -0.31828,  -2.8103,  -0.66204,  4.7026,  -1.3074,  1.2439,
            -1.0261,  -9.5799,  -1.8919,  15.897,  -4.6259,  3.6706,
            50.694,  -62.772,  5.8053,  14.706,  41.856,  -18.525,
            2.4253,  1.7334,  -1.6794,  -4.6268,  6.7422,  0.41524,
            -1.4938,  -28.587,  -4.9481,  26.054,  -25.143,  12.452,
            -0.13189,  0.097353,  2.8862,  -5.4818,  -0.10754,  -2.7333,
            -30.848,  -188.01,  53.23,  210.1,  43.304,  -77.985,
            -1.269,  -16.676,  3.0152,  14.242,  9.7184,  -5.8338,
            4.8003,  -11.002,  2.0218,  8.347,  25.742,  -30.615,
            10.942,  -29.325,  3.2249,  21.003,  63.909,  -64.084,
            0.31828,  0.66204,  2.8103,  -1.2439,  1.3074,  -4.7026,
            1.0261,  1.8919,  9.5799,  -3.6706,  4.6259,  -15.897,
            -1.4938,  -4.9481,  -28.587,  12.452,  -25.143,  26.054,
            -0.13189,  2.8862,  0.097353,  -2.7333,  -0.10754,  -5.4818,
            50.694,  5.8053,  -62.772,  -18.525,  41.856,  14.706,
            2.4253,  -1.6794,  1.7334,  0.41524,  6.7422,  -4.6268,
            -30.848,  53.23,  -188.01,  -77.985,  43.304,  210.1,
            -1.269,  3.0152,  -16.676,  -5.8338,  9.7184,  14.242,
};

// ==== 基本运动（PID 增益）====
constexpr PidGains kLeftL0Pid{8500.0f, 0.04f, 90000.0f, 170.0f, 10.0f};   ///< 左腿腿长 PID（常规）
constexpr PidGains kRightL0Pid{8500.0f, 0.04f, 90000.0f, 170.0f, 10.0f};  ///< 右腿腿长 PID（常规）
constexpr PidGains kRollPid{1000.0f, 0.0f, 230.0f, 180.0f, 0.0f};          ///< 横滚平衡 PID
...
constexpr PidGains kYawFollowPid{8.0f, 0.0f, 2.2f, 10.0f, 0.0f};  ///< 偏航跟随 PID
