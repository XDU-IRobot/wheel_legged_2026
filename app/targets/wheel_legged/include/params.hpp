...
constexpr PidGains kYawSpeedPid{0.9f, 0.0f, 0.0f, 10.0f, 0.4f};          ///< 偏航速度 PID
...
inline constexpr PidGains kYawPositionPid{22.0f, 0.f, 1.f, 10.0f, 0.0f};     ///< 偏航位置 PID
inline constexpr PidGains kYawSpeedPid{0.55f, 0.0f, 0.0f, 6.0f, 0.4f};       ///< 偏航速度 PID
inline constexpr PidGains kPitchPositionPid{50.0f, 0.f, 4.3f, 10.0f, 0.6f};  ///< 俯仰位置 PID
...
constexpr float kPositionErrorScaleLowLeg = 0.1f;    ///< 低腿长位置误差缩放
constexpr float kVelocityErrorScaleLowLeg = 1.2f;    ///< 低腿长速度误差缩放
constexpr float kPositionErrorScaleMidLeg = 1.0f;    ///< 中腿长位置误差缩放
constexpr float kVelocityErrorScaleMidLeg = 1.0f;    ///< 中腿长速度误差缩放
constexpr float kPositionErrorScaleHighLeg = 1.0f;   ///< 高腿长位置误差缩放
constexpr float kVelocityErrorScaleHighLeg = 1.0f;   ///< 高腿长速度误差缩放
