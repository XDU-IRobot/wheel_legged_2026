...
// ==== 跳跃（PID 增益）====
constexpr PidGains kLeftL0PidJumpTwo{3000.0f, 0.0f, 4000.0f, 250.0f, 0.0f};     ///< 左腿蹬伸 PID
constexpr PidGains kRightL0PidJumpTwo{3000.0f, 0.0f, 4000.0f, 250.0f, 0.0f};    ///< 右腿蹬伸 PID
constexpr PidGains kLeftL0PidJumpThree{3000.0f, 0.f, 5000.0f, 170.0f, 30.0f};   ///< 左腿回收 PID
constexpr PidGains kRightL0PidJumpThree{3000.0f, 0.f, 5000.0f, 170.0f, 30.0f};  ///< 右腿回收 PID
