...
bool IsJumpState(const chassis::Fsm::State mode) {
  return mode == chassis::Fsm::State::kJumpPrep ||
         mode == chassis::Fsm::State::kJumpPush ||
...
chassis::Fsm::Output::ControlOutput BuildControlOutput(
...
struct ModeRequestEvent : public etl::message<1> {
  ...
  explicit ModeRequestEvent(const bool force_enable,
                            const bool spin_enable,
                            const bool jump_trigger_rise,
                            const bool fall_detected,
                            const bool upright_stable,
...
class DisabledState : public etl::fsm_state<FsmEtlContext, DisabledState,
                                            kDisabledState, ModeRequestEvent> {
 public:
...
class StandbyState : public etl::fsm_state<FsmEtlContext, StandbyState,
                                           kStandbyState, ModeRequestEvent> {
 public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
  etl::fsm_state_id_t on_enter_state();
...
class BalanceState : public etl::fsm_state<FsmEtlContext, BalanceState,
                                           kBalanceState, ModeRequestEvent> {
 public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
  etl::fsm_state_id_t on_enter_state();
...
class SpinState : public etl::fsm_state<FsmEtlContext, SpinState,
                                        kSpinState, ModeRequestEvent> {
 public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
  etl::fsm_state_id_t on_enter_state();
...
class JumpPrepState : public etl::fsm_state<FsmEtlContext, JumpPrepState,
                                            kJumpPrepState, ModeRequestEvent> {
 public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
  etl::fsm_state_id_t on_enter_state();
...
class JumpPushState : public etl::fsm_state<FsmEtlContext, JumpPushState,
                                            kJumpPushState, ModeRequestEvent> {
 public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
  etl::fsm_state_id_t on_enter_state();
...
class JumpRecoverState
    : public etl::fsm_state<FsmEtlContext, JumpRecoverState, kJumpRecoverState,
                            ModeRequestEvent> {
 public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
...
class RecoveryFallCheckState
    : public etl::fsm_state<FsmEtlContext, RecoveryFallCheckState,
                            kRecoveryFallCheckState, ModeRequestEvent> {
 public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
  etl::fsm_state_id_t on_enter_state();
...
class RecoverySelfRightState
    : public etl::fsm_state<FsmEtlContext, RecoverySelfRightState,
                            kRecoverySelfRightState, ModeRequestEvent> {
 public:
  etl::fsm_state_id_t on_event(const ModeRequestEvent &event);
  etl::fsm_state_id_t on_event_unknown(const etl::imessage &);
  etl::fsm_state_id_t on_enter_state();
...
etl::fsm_state_id_t DisabledState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t StandbyState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t BalanceState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t SpinState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t JumpPrepState::on_event(const ModeRequestEvent &event) {
  ...
  return get_fsm_context().JumpPhaseElapsedMs() >= kJumpPrepMs
             ? kJumpPushState
             : No_State_Change;
}

etl::fsm_state_id_t JumpPrepState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t JumpPushState::on_event(const ModeRequestEvent &event) {
  ...
  const bool leg_reached =
      event.current_leg_length_m >= (kJumpPushTargetLegLengthM - kJumpPushReachTolM);
...
etl::fsm_state_id_t JumpPushState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t JumpRecoverState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t RecoveryFallCheckState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
...
etl::fsm_state_id_t RecoverySelfRightState::on_event_unknown(const etl::imessage &) {
  return No_State_Change;
}
