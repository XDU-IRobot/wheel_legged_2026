...
INFANTRY3_QR_POINTS: list[QrPoint] = [
    QrPoint(
        0.14,
        np.diag([200.0, 140.0, 200.0, 1.0, 1300.0, 1.0, 1300.0, 1.0, 4000.0, 1.0]),
        np.diag([2., 2., 0.2, 0.2]),
    ),
    QrPoint(
        0.155,
        np.diag([200.0, 120.0, 200.0, 1.0, 1300.0, 1.0, 1300.0, 1.0, 4000.0, 1.0]),
        np.diag([2., 2., 0.2, 0.2]),
    ),
    # QrPoint(
    #     0.185,
    ...
    QrPoint(
        0.195,
        np.diag([200.0, 120.0, 200.0, 1.0, 1300.0, 1.0, 1300.0, 1.0, 4200.0, 1.0]),
        np.diag([2., 2., 0.2, 0.2]),
   ),
    QrPoint(
        0.245,
        np.diag([160.0, 100.0, 200.0, 1.0, 1350.0, 1.0, 1350.0, 1.0, 4200.0, 1.0]),
        np.diag([2., 2., 0.25, 0.25]),
    ),
    QrPoint(
        0.33,
        np.diag([150.0, 50.0, 200.0, 1.0, 1400.0, 1.0, 1400.0, 1.0, 4500.0, 1.0]),
