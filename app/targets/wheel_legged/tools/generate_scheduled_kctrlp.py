...
HERO_QR_POINTS: list[QrPoint] = [
    ...
    QrPoint(
        0.14,
        np.diag([200.0, 110.0, 210.0, 1.0, 1250.0, 1.0, 1250.0, 1.0, 3200.0, 1.0]),
        np.diag([2.6, 2.6, 0.35, 0.35]),
    ),
    QrPoint(
        0.155,
        np.diag([200.0, 100.0, 210.0, 1.0, 1250.0, 1.0, 1250.0, 1.0, 3200.0, 1.0]),
    ...
    QrPoint(
        0.195,
        np.diag([200.0, 100.0, 210.0, 1.0, 1250.0, 1.0, 1250.0, 1.0, 3800.0, 1.0]),
        np.diag([3.6, 3.6, 0.5, 0.5]),
    ),
    QrPoint(
        0.245,
        np.diag([160.0, 90.0, 210.0, 1.0, 1250.0, 1.0, 1250.0, 1.0, 3800.0, 1.0]),
        np.diag([3.8, 3.8, 0.5, 0.5]),
    ),
    QrPoint(
        0.33,
        np.diag([150.0, 90.0, 210.0, 1.0, 1300.0, 1.0, 1300.0, 1.0, 4000.0, 1.0]),
        np.diag([3.8, 3.8, 0.5, 0.5]),
    ),
]
...
INFANTRY3_QR_POINTS: list[QrPoint] = [
    QrPoint(
        0.14,
        np.diag([200.0, 140.0, 200.0, 1.0, 1200.0, 1.0, 1200.0, 1.0, 3200.0, 1.0]),
        np.diag([2.6, 2.6, 0.35, 0.35]),
    ),
    QrPoint(
        0.155,
        np.diag([200.0, 120.0, 200.0, 1.0, 1200.0, 1.0, 1200.0, 1.0, 3200.0, 1.0]),
        np.diag([2.8, 2.8, 0.4, 0.4]),
    ),
    # QrPoint(
    #     0.185,
    ...
    QrPoint(
        0.195,
        np.diag([200.0, 120.0, 200.0, 1.0, 1200.0, 1.0, 1200.0, 1.0, 3800.0, 1.0]),
        np.diag([3.6, 3.6, 0.5, 0.5]),
   ),
    QrPoint(
        0.245,
        np.diag([160.0, 100.0, 200.0, 1.0, 1200.0, 1.0, 1200.0, 1.0, 3800.0, 1.0]),
        np.diag([4., 4., 0.5, 0.5]),
    ),
    QrPoint(
        0.33,
        np.diag([150.0, 50.0, 200.0, 1.0, 1300.0, 1.0, 1300.0, 1.0, 4000.0, 1.0]),
        np.diag([4., 4., 0.5, 0.5]),
    ),
