...
HERO_QR_POINTS: list[QrPoint] = [
    QrPoint(
        0.16,
        np.diag([200.0, 120.0, 50.0, 10.0, 1000.0, 1.0, 1000.0, 1.0, 3200.0, 1.0]),
...
INFANTRY3_QR_POINTS: list[QrPoint] = [
    ...
    QrPoint(
        0.195,
        np.diag([200.0, 120.0, 200.0, 1.0, 1200.0, 5.0, 1200.0, 5.0, 3800.0, 1.0]),
        np.diag([3.6, 3.6, 0.5, 0.5]),
   ),
    QrPoint(
        0.245,
        np.diag([160.0, 100.0, 200.0, 1.0, 1200.0, 5.0, 1200.0, 5.0, 3800.0, 1.0]),
        np.diag([4., 4., 0.5, 0.5]),
    ),
    QrPoint(
        0.33,
