...
INFANTRY3_QR_POINTS: list[QrPoint] = [
    ...
    QrPoint(
        0.18,
        np.diag([200.0, 120.0, 50.0, 10.0, 1200.0, 1.0, 1200.0, 1.0, 3200.0, 1.0]),
        np.diag([2.4, 2.4, 0.4, 0.4]),
    ),
    QrPoint(
        0.20,
        np.diag([200.0, 120.0, 50.0, 10.0, 1400.0, 1.0, 1400.0, 1.0, 3200.0, 1.0]),
        np.diag([2.3, 2.3, 0.4, 0.4]),
    ),
    # QrPoint(
    #     0.33,
    #     np.diag([10.0, 150.0, 1.0, 10.0, 1200.0, 1.0, 1200.0, 1.0, 3000.0, 1.0]),
    #     np.diag([3.0, 3.0, 0.4, 0.4]),
    # ),
]
