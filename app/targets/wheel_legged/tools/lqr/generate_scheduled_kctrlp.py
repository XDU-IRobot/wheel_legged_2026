...
HERO_QR_POINTS: list[QrPoint] = [
    QrPoint(
        0.17,
        np.diag([250.0, 300.0, 300.0, 2.0, 3000.0, 1.0, 3000.0, 1.0, 5000.0, 1.0]),
        np.diag([2.5, 2.5, 0.4, 0.4]),
    ),
    # QrPoint(
    #     0.155,
    ...
    QrPoint(
        0.21,
        np.diag([250.0, 300.0, 300.0, 2.0, 3300.0, 1.0, 3300.0, 1.0, 6000.0, 1.0]),
        np.diag([3.2, 3.2, 0.5, 0.5]),
        # np.diag([250.0, 300.0, 300.0, 2.0, 3000.0, 1.0, 3000.0, 1.0, 5000.0, 1.0]),
        # np.diag([2.5, 2.5, 0.4, 0.4]),
    ),
    QrPoint(
        0.33,
        np.diag([300.0, 300.0, 300.0, 2.0, 4000.0, 1.5, 4000.0, 1.5, 6000.0, 1.0]),
        np.diag([4., 4., 0.6, 0.6]),
    ),
]
...
INFANTRY3_QR_POINTS: list[QrPoint] = [
   ...
   # ),
    QrPoint(
        0.245,
        np.diag([200.0, 140.0, 200.0, 2.0, 2000.0, 1.0, 2000.0, 1.0, 4200.0, 1.0]),
        np.diag([3.8, 3.8, 0.45, 0.45]),
    ),
    QrPoint(
        0.33,
        np.diag([200.0, 300.0, 200.0, 2.0, 4000.0, 1.5, 4000.0, 1.5, 4500.0, 1.0]),
        np.diag([3.8, 3.8, 0.45, 0.45]),
    ),
