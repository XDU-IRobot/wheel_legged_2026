...
HERO_QR_POINTS: list[QrPoint] = [
    QrPoint(
        0.17,
        np.diag([250.0, 200.0, 300.0, 2.0, 3000.0, 1.0, 3000.0, 1.0, 5000.0, 1.0]),
        np.diag([2., 2., 0.4, 0.4]),
    ),
    # QrPoint(
    #     0.155,
    ...
    QrPoint(
        0.245,
        np.diag([250.0, 200.0, 300.0, 2.0, 2700.0, 1.0, 2700.0, 1.0, 5200.0, 1.0]),
        np.diag([3., 3., 0.55, 0.55]),
    ),
    QrPoint(
        0.33,
        np.diag([300.0, 300.0, 300.0, 2.0, 4000.0, 1.5, 4000.0, 1.5, 5500.0, 1.0]),
        np.diag([4., 4., 0.6, 0.6]),
    ),
]
