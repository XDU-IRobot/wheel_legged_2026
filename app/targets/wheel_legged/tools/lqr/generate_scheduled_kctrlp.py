...
HERO_QR_POINTS: list[QrPoint] = [
    QrPoint(
        0.17,
        np.diag([200.0, 140.0, 200.0, 2.0, 2500.0, 1.0, 2500.0, 1.0, 4500.0, 1.0]),
    ...
    QrPoint(
        0.245,
        np.diag([200.0, 140.0, 200.0, 2.0, 2500.0, 1.0, 2500.0, 1.0, 4700.0, 1.0]),
        np.diag([3.8, 3.8, 0.45, 0.45]),
    ),
    QrPoint(
        0.33,
        np.diag([200.0, 300.0, 200.0, 2.0, 4000.0, 1.5, 4000.0, 1.5, 5000.0, 1.0]),
        np.diag([3.8, 3.8, 0.45, 0.45]),
    ),
]
