...
void UpdateDebugSnapshot(const uint32_t tick_ms, const wheel_legged::control_loop::InputSnapshot &input,
  ...
  wl_debug.chassis_left_force_no_spring_n = chassis_control_output.left_force_no_spring_n;
  wl_debug.chassis_right_force_no_spring_n = chassis_control_output.right_force_no_spring_n;
