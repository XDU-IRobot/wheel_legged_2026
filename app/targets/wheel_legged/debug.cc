...
#undef COPY_TOF_DEBUG
  ...
  wl_debug.auto_jump_mode = input.highland_auto_jump_enabled ? 2U : input.auto_jump_enabled ? 1U : 0U;
  ...
  wl_debug.yaw_motor_raw_pos_rad = input.estimator_input.yaw_motor_rad * (180.0f / wheel_legged::params::active::kPi);
